<template>
  <div class="shade">
    ...
    /> -->
    <div class="fixed-box">
      <a class="down-btn" :href="downUrl"><img src="@/assets/img/down_01.png" /></a>
    </div>
  </div>
</template>
...
export default {
  ...
  created () {
    const appParams = this.$route.query.appParams
    window.location = 'mhshjyScheme://?' + appParams
...
.shade {
  ...
  top: 0;
  bottom: 0;
  background: #fff url(../assets/img/down_02.png) no-repeat center top / 100% auto;
}
.fixed-box {
  height: 160px;
  width: 100%;
